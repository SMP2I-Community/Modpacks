...
event.recipes.create.sequenced_assembly(
      [
        CreateItem.of('apothic_enchanting:flimsy_ender_lead', 0.80), // Main output, will appear in JEI as the result
        CreateItem.of('minecraft:lead', 0.20), // Rest of these items will be considered Random Salvage
      ],
      'minecraft:lead', 
      [
        event.recipes.create.filling('farmersdelight:rope', ['farmersdelight:rope', Fluid.ingredientOf('create:potion', {'create:potion_fluid_bottle_type': 'regular','minecraft:potion_contents': {potion:'minecraft:healing',},}).withAmount(250)]),
        event.recipes.create.deploying('farmersdelight:rope', ['farmersdelight:rope', 'minecraft:ender_eye',]),
        event.recipes.create.pressing('farmersdelight:rope', 'farmersdelight:rope'),
      ]
    )
    .transitionalItem('farmersdelight:rope')
...
event.remove({ input: 'createbigcannons:steel_ingot' })
event.remove({ input: 'createbigcannons:steel_scrap' })
event.remove({ input: 'createbigcannons:steel_block' })
...
event.remove({ input: 'createbigcannons:bronze_ingot' })
event.remove({ input: 'createbigcannons:bronze_scrap' })
event.remove({ input: 'createbigcannons:bronze_block' })

event.remove({ output: 'createbigcannons:bronze_ingot' })
event.remove({ output: 'createbigcannons:bronze_scrap' })
event.remove({ output: 'createbigcannons:bronze_block' })

event.recipes.create.mixing([CreateItem.of('minecraft:netherrack',0.4), CreateItem.of('minecraft:netherite_scrap', 0.003)],['6x create:cinder_flour',Fluid.ingredientOf('create:potion', {'create:potion_fluid_bottle_type': 'regular','minecraft:potion_contents': {potion:'minecraft:healing',},}).withAmount(250)],).heated()
