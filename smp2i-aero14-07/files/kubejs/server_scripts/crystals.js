...
event.recipes.create.sequenced_assembly(
    'b3_worldborder:expandercrystal_t4', 
      ...
      [
        ...
        event.recipes.create.deploying('b3_worldborder:unstable_t4', ['b3_worldborder:unstable_t4',['alexscaves:radiant_essence', 'alexscaves:gazing_pearl', 'alexscaves:pure_darkness', 'alexscaves:fissile_core', 'minecraft:nether_star']]),
